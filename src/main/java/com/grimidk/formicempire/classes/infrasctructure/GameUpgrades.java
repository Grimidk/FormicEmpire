...
public final class GameUpgrades {
    ...
    public static final Upgrade TYPE_PRINCESS = new Upgrade(5, "Princess and Drone Types", "Winged Ants", "Unlocks the princess and drone types, so new colonies can exist.", TYPE_EGG,3000 );
    ...
    // -- Roles --
    public static final Upgrade ROLE_FORAGER = new Upgrade(7, "Forager Role", "Nature's Bounty", "Allows workers to collect plants and mushrooms. 1 ant can collect 1 resource per hour. Your colony can hold 8000 mushrooms and 4000 plants.", TYPE_WORKER, 0 );
    ...
    public static final Upgrade ROLE_RANCHER = new Upgrade(13, "Rancher Role", "Aphid Rancher", "Allows workers to ranch aphids. 1 ant can handle 10 aphids and herd 1 additional aphid per day. Each aphid produces 1 hoenydew (syrup) and your colony has a capacity of 500.", ROLE_FORAGER, 1000 );
    ...
    public static final Upgrade ROLE_BUILDER = new Upgrade(15, "Builde Role", "", "", TYPE_WORKER, 0 );
    public static final Upgrade ROLE_SCOUT = new Upgrade(16, "Scout Role", "", "", TYPE_WORKER, 0 );
    public static final Upgrade ROLE_MINER = new Upgrade(17, "Miner Role", "", "", TYPE_WORKER, 0 );        // this.mineralsCapacity = 100;
    public static final Upgrade ROLE_COURIER = new Upgrade(18, "Courier Role", "", "", TYPE_WORKER, 0 );
    public static final Upgrade ROLE_POTTER = new Upgrade(19, "Portable-Feeder Role", "", "", TYPE_WORKER, 0 );
    public static final Upgrade ROLE_GUARD = new Upgrade(20, "Guard Role", "", "", TYPE_SOLDIER, 0 );
    public static final Upgrade ROLE_WARRIOR = new Upgrade(21, "Warrior Role", "", "", TYPE_SOLDIER, 0 );
    public static final Upgrade ROLE_DEFENDER = new Upgrade(22, "Defender Role", "", "", TYPE_SOLDIER, 0 );
    public static final Upgrade ROLE_POLICE = new Upgrade(23, "Parasite-Police Role", "", "", TYPE_SOLDIER, 0 );  // this.parasiteDetection = 10;
    public static final Upgrade ROLE_BOMBER = new Upgrade(24, "Bomber Role", "", "", TYPE_SOLDIER, 0 );
    public static final Upgrade ROLE_BRUTE = new Upgrade(25, "Brute Role", "", "", TYPE_MAJOR, 0 );
    public static final Upgrade ROLE_CARRIER = new Upgrade(26, "Carrier Role", "", "", TYPE_MAJOR, 0 );
    public static final Upgrade ROLE_ARTILLERY = new Upgrade(27, "Artillery Role", "", "", TYPE_MAJOR, 0 );
    public static final Upgrade ROLE_SIEGE = new Upgrade(28, "Siege-Machine Role", "", "", TYPE_MAJOR, 0 );
    public static final Upgrade ROLE_BORER = new Upgrade(29, "Tunel-Borer Role", "", "", TYPE_MAJOR, 0 );
    public static final Upgrade ROLE_BREEDER = new Upgrade(30,"Breeder Roles", "", "", TYPE_PRINCESS, 0 );
    public static final Upgrade ROLE_DIPLOMAT = new Upgrade(31, "Diplomat Role", "", "", TYPE_PRINCESS, 0 );
    // -- Stats -- 
    ...
    // -- Abilities --
    public static final Upgrade ABILITY_RESEARCH = new Upgrade(35, "Research", "Micro Microscopes", "Allows you to research more ant technology by using research points.", ROLE_RESEARCHER, 0 );
