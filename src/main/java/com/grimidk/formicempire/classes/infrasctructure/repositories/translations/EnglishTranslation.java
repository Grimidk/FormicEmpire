...
public class EnglishTranslation implements Translation {
    ...
    public Map<String, String> getStrings() {
        ...
        en.put("COLONY_TOTAL_RESOURCES", "Total resources: %d");
        en.put("COLONY_TOTAL_ANTS", "Total ants: %d");
        en.put("COLONY_QUEENS", "Queens: %d / %d");
        en.put("COLONY_CONSUMPTION", "Consumption: %d/day");
        en.put("COLONY_MAX_FOOD_PROD", "Max Food Prod: %d/day");
        en.put("COLONY_NET_FOOD", "Net Food: %d/day");
        ...
        en.put("UPGRADE_RESEARCH_AVAILABLE", "Available Research Points: %d");
        en.put("UPGRADE_NO_RESEARCH", "  No new research available at this time.");
        en.put("UPGRADE_COST_RP", "%d RP");
        ...
        en.put("BUILD_PROGRESS_HOURS", "%.1f / %.1f Hours");
        en.put("BUILD_STATUS_BUILDERS", "%d Builders");
        en.put("BUILD_STATUS_CRANES", "%d Cranes");
        ...
        en.put("BUILD_COST_FORMAT", "<html>%d Minerals<br>%d Resin<br>%d Hours (base)</html>");
        ...
        en.put("ASSIMILATION_TARGET", "Target: %d");
        en.put("ASSIMILATION_ACTIVE", "Assimilating: %s");
        en.put("ASSIMILATION_PROGRESS", "%.1f / %d ( %d%% )");
        ...
        en.put("ABILITY_RP_LABEL", "Research Points: %d");
        en.put("ABILITY_NO_ABILITIES", "No active abilities unlocked yet.");
        en.put("ABILITY_FORCED_FLIGHT", "Forced Nuptial Flight");
        en.put("ABILITY_FORCED_FLIGHT_DESC", "Spend %d RP to immediately trigger a nuptial flight.\nRequires Drones and Breeder Princesses.");
        en.put("ABILITY_MASS_FLIGHT", "Mass Nuptial Flights");
        en.put("ABILITY_MASS_FLIGHT_DESC", "Spend %d RP to trigger nuptial flights in ALL capable colonies across your dynasty.");
        en.put("ABILITY_ERROR_NOT_ENOUGH_RP", "Not enough Research Points (%d needed).");
        ...
        en.put("STAT_PTS_DAY_FORMAT", "+%d pts/day");
        ...
        en.put("ROLE_TOTAL_PREFIX", "Total %ss: %d");
        en.put("ROLE_ASSIGNED_PREFIX", "Total Assigned: %d");
        en.put("ROLE_UNASSIGNED_PREFIX", "Unassigned: %d");
        ...
        en.put("MAP_POPULATION_FORMAT", "Population: %d");
        ...
        en.put("TRADE_CAPACITY_FORMAT", "Capacity: %.1f / %.1f");
        en.put("TRADE_SPEED_FORMAT", "Transit Speed: %.2fx");
        en.put("TRADE_TIME_FORMAT", "Travel Time: %dh");
        ...
        en.put("SAVE_DAYS_FORMAT", "%s — %d days");
        ...
        en.put("SAVE_DELETE_CONFIRM", "Delete save in slot %d?");
