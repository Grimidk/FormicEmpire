...
public final class GameUnlocks {
    ...
    public static final Assimilation ASSIMILATION_PHARAOH = new Assimilation(2, "ASSIMILATION_PHARAOH", "ASSIMILATION_PHARAOH_DESC", ASSIMILATED_MULTIQUEEN, 10000, null);
    static { assimilations.add(ASSIMILATION_PHARAOH); }
    public static final Assimilation ASSIMILATION_MARAUDER = new Assimilation(3, "ASSIMILATION_MARAUDER", "ASSIMILATION_MARAUDER_DESC", TYPE_MAJOR, 15000, null);
