...
public final class GameUnlocks {
        ...
        public static final Upgrade TYPE_EGG = new Upgrade(1, "TYPE_EGG", "TYPE_EGG_FLAVOR", "TYPE_EGG_DESC", null, 0, null );
        static { upgrades.add(TYPE_EGG); }
        // TODO asset: icons/types/Worker.png (upgrade tree icon)
        public static final Upgrade TYPE_WORKER = new Upgrade(2, "TYPE_WORKER", "TYPE_WORKER_FLAVOR", "TYPE_WORKER_DESC", TYPE_EGG, 0, null );
        static { upgrades.add(TYPE_WORKER); }
        // TODO asset: icons/types/Soldier.png (upgrade tree icon)
        public static final Upgrade TYPE_SOLDIER = new Upgrade(3, "TYPE_SOLDIER", "TYPE_SOLDIER_FLAVOR", "TYPE_SOLDIER_DESC", TYPE_EGG, 100, null );
        ...
        public static final Upgrade ROLE_FORAGER = new Upgrade(7, "ROLE_FORAGER_UPGRADE", "ROLE_FORAGER_FLAVOR", "ROLE_FORAGER_DESC", TYPE_WORKER, 0, null );
        static { upgrades.add(ROLE_FORAGER); }
        // TODO asset: icons/roles/Nurse.png (upgrade tree icon; may diverge from role icon)
        public static final Upgrade ROLE_NURSE = new Upgrade(8, "ROLE_NURSE_UPGRADE", "ROLE_NURSE_FLAVOR", "ROLE_NURSE_DESC", TYPE_WORKER, 0, null );
        static { upgrades.add(ROLE_NURSE); }
        // TODO asset: icons/roles/Farmer.png (upgrade tree icon; may diverge from role icon)
        public static final Upgrade ROLE_FARMER = new Upgrade(9, "ROLE_FARMER_UPGRADE", "ROLE_FARMER_FLAVOR", "ROLE_FARMER_DESC", TYPE_WORKER, 0, null );
        static { upgrades.add(ROLE_FARMER); }
        // TODO asset: icons/roles/Graver.png (upgrade tree icon; may diverge from role icon)
        public static final Upgrade ROLE_GRAVER = new Upgrade(10, "ROLE_GRAVER_UPGRADE", "ROLE_GRAVER_FLAVOR", "ROLE_GRAVER_DESC", TYPE_WORKER, 0, null );
        static { upgrades.add(ROLE_GRAVER); }
        // TODO asset: icons/roles/Hunter.png (upgrade tree icon; may diverge from role icon)
        public static final Upgrade ROLE_HUNTER = new Upgrade(11, "ROLE_HUNTER_UPGRADE", "ROLE_HUNTER_FLAVOR", "ROLE_HUNTER_DESC", TYPE_SOLDIER, 0, null );
        ...
        public static final Upgrade ABILITY_RESEARCH = new Upgrade(201, "ABILITY_RESEARCH", "ABILITY_RESEARCH_FLAVOR", "ABILITY_RESEARCH_DESC", ROLE_RESEARCHER, 0, null );
        static { upgrades.add(ABILITY_RESEARCH); }
        // TODO asset: icons/upgrades/AbilityBuild.png
        public static final Upgrade ABILITY_BUILD = new Upgrade(202, "ABILITY_BUILD", "ABILITY_BUILD_FLAVOR", "ABILITY_BUILD_DESC", ROLE_BUILDER, 0, null );
        static { upgrades.add(ABILITY_BUILD); }
        // TODO asset: icons/upgrades/AbilitySpread.png
        public static final Upgrade ABILITY_SPREAD = new Upgrade(203, "ABILITY_SPREAD", "ABILITY_SPREAD_FLAVOR", "ABILITY_SPREAD_DESC", ROLE_BREEDER, 0, null );
        static { upgrades.add(ABILITY_SPREAD); }
        // TODO asset: icons/upgrades/AbilityResin.png
        public static final Upgrade ABILITY_RESIN = new Upgrade(204, "ABILITY_RESIN", "ABILITY_RESIN_FLAVOR", "ABILITY_RESIN_DESC", ROLE_FORAGER, 5000, null );
        static { upgrades.add(ABILITY_RESIN); }
        // TODO asset: icons/upgrades/AbilitySynergy.png
        public static final Upgrade ABILITY_SYNERGY = new Upgrade(205, "ABILITY_SYNERGY", "ABILITY_SYNERGY_FLAVOR", "ABILITY_SYNERGY_DESC", ABILITY_RESEARCH, 0, null);
        static { upgrades.add(ABILITY_SYNERGY); }
        // TODO asset: icons/upgrades/AbilityAssimilation.png
        public static final Upgrade ABILITY_ASSIMILATION = new Upgrade(206, "ABILITY_ASSIMILATION", "ABILITY_ASSIMILATION_FLAVOR", "ABILITY_ASSIMILATION_DESC", ABILITY_RESEARCH, 0, null);
        static { upgrades.add(ABILITY_ASSIMILATION); }
        // TODO asset: icons/upgrades/AbilityForcedFlight.png
        public static final Upgrade ABILITY_FORCED_FLIGHT = new Upgrade(505, "ABILITY_FORCED_FLIGHT", "ABILITY_FORCED_FLIGHT_FLAVOR", "ABILITY_FORCED_FLIGHT_DESC", ROLE_BREEDER, 9000, null);
        static { upgrades.add(ABILITY_FORCED_FLIGHT); }
        // TODO asset: icons/upgrades/AbilityDynasty.png
        public static final Upgrade ABILITY_DYNASTY = new Upgrade(506, "ABILITY_DYNASTY", "ABILITY_DYNASTY_FLAVOR", "ABILITY_DYNASTY_DESC", ABILITY_SPREAD, 0, null);
        static { upgrades.add(ABILITY_DYNASTY); }
        // TODO asset: icons/upgrades/AbilityTrade.png
        public static final Upgrade ABILITY_TRADE = new Upgrade(507, "ABILITY_TRADE", "ABILITY_TRADE_FLAVOR", "ABILITY_TRADE_DESC", ABILITY_DYNASTY, 0, null);
        static { upgrades.add(ABILITY_TRADE); }
        // TODO asset: icons/upgrades/AbilitySpread2.png
        public static final Upgrade ABILITY_SPREAD_2 = new Upgrade(508, "ABILITY_SPREAD_2", "ABILITY_SPREAD_2_FLAVOR", "ABILITY_SPREAD_2_DESC", ABILITY_SPREAD, 0, null);
        static { upgrades.add(ABILITY_SPREAD_2); }
        // TODO asset: icons/upgrades/AbilityAutomation.png
        public static final Upgrade ABILITY_AUTOMATION = new Upgrade(509, "ABILITY_AUTOMATION", "ABILITY_AUTOMATION_FLAVOR", "ABILITY_AUTOMATION_DESC", ABILITY_DYNASTY, 0, null);
        static { upgrades.add(ABILITY_AUTOMATION); }
        // TODO asset: icons/upgrades/AbilityTunnels.png
        public static final Upgrade ABILITY_TUNNELS =  new Upgrade(510, "ABILITY_TUNNELS", "ABILITY_TUNNELS_FLAVOR", "ABILITY_TUNNELS_DESC", ABILITY_TRADE, 100000, null);
        static { upgrades.add(ABILITY_TUNNELS); }
        // TODO asset: icons/upgrades/AbilityBilateralTrade.png
        public static final Upgrade ABILITY_BILATERAL_TRADE = new Upgrade(513, "ABILITY_BILATERAL_TRADE", "ABILITY_BILATERAL_TRADE_FLAVOR", "ABILITY_BILATERAL_TRADE_DESC", ABILITY_TRADE, 0, null);
        static { upgrades.add(ABILITY_BILATERAL_TRADE); }
        // TODO asset: icons/upgrades/AbilityManagement.png
        public static final Upgrade ABILITY_MANAGEMENT = new Upgrade(511, "ABILITY_MANAGEMENT", "ABILITY_MANAGEMENT_FLAVOR", "ABILITY_MANAGEMENT_DESC", ABILITY_DYNASTY, 0, null);
        static { upgrades.add(ABILITY_MANAGEMENT); }
        // TODO asset: icons/upgrades/AbilityMassFlight.png
        public static final Upgrade ABILITY_MASS_FLIGHT = new Upgrade(512, "ABILITY_MASS_FLIGHT", "ABILITY_MASS_FLIGHT_FLAVOR", "ABILITY_MASS_FLIGHT_DESC", ABILITY_FORCED_FLIGHT, 0, null);
        ...
        public static final Upgrade ROLE_BORER = new Upgrade(29, "ROLE_BORER_UPGRADE", "ROLE_BORER_FLAVOR", "ROLE_BORER_DESC", ABILITY_TUNNELS, 0, null );
        static { upgrades.add(ROLE_BORER); }
        // TODO asset: icons/roles/Transport.png (upgrade tree icon; may diverge from role icon)
        public static final Upgrade ROLE_TRANSPORT = new Upgrade(35, "ROLE_TRANSPORT_UPGRADE", "ROLE_TRANSPORT_FLAVOR", "ROLE_TRANSPORT_DESC", ROLE_COURIER, 100000, null );
        static { upgrades.add(ROLE_TRANSPORT); }
        // TODO asset: icons/roles/Escort.png (upgrade tree icon; may diverge from role icon)
        public static final Upgrade ROLE_ESCORT = new Upgrade(37, "ROLE_ESCORT_UPGRADE", "ROLE_ESCORT_FLAVOR", "ROLE_ESCORT_DESC", ROLE_COURIER, 80000, null );
        static { upgrades.add(ROLE_ESCORT); }
        // TODO asset: icons/roles/Engineer.png (upgrade tree icon; may diverge from role icon)
        public static final Upgrade ROLE_ENGINEER = new Upgrade(38, "ROLE_ENGINEER_UPGRADE", "ROLE_ENGINEER_FLAVOR", "ROLE_ENGINEER_DESC", ROLE_BORER, 50000, null );
        static { upgrades.add(ROLE_ENGINEER); }
        // TODO asset: icons/roles/Skytrans.png (upgrade tree icon; may diverge from role icon)
        public static final Upgrade ROLE_SKYTRANS = new Upgrade(39, "ROLE_SKYTRANS_UPGRADE", "ROLE_SKYTRANS_FLAVOR", "ROLE_SKYTRANS_DESC", ROLE_COURIER, 150000, null );
        static { upgrades.add(ROLE_SKYTRANS); }

        // -- Stats -- 
        // TODO asset: icons/upgrades/StatSkeleton.png
        public static final Upgrade STAT_SKELETON = new Upgrade(101, "STAT_SKELETON", "STAT_SKELETON_FLAVOR", "STAT_SKELETON_DESC", TYPE_EGG, 0, null );
        static { upgrades.add(STAT_SKELETON); }
        // TODO asset: icons/upgrades/StatAcid.png
        public static final Upgrade STAT_ACID = new Upgrade(102, "STAT_ACID", "STAT_ACID_FLAVOR", "STAT_ACID_DESC", TYPE_EGG, 0, null );
        ...
        public static final Upgrade STAT_GROWTH_2 = new Upgrade(108, "STAT_GROWTH_2", "STAT_GROWTH_2_FLAVOR", "STAT_GROWTH_2_DESC", STAT_GROWTH_1, 9000, null );
        static { upgrades.add(STAT_GROWTH_2); }
        // TODO asset: icons/upgrades/StatGrowth3.png
        public static final Upgrade STAT_GROWTH_3 = new Upgrade(109, "STAT_GROWTH_3", "STAT_GROWTH_3_FLAVOR", "STAT_GROWTH_3_DESC", STAT_GROWTH_2, 20000, null );
        static { upgrades.add(STAT_GROWTH_3); }
        // TODO asset: icons/upgrades/StatThirst1.png
        public static final Upgrade STAT_THIRST_1 = new Upgrade(110, "STAT_THIRST_1", "STAT_THIRST_1_FLAVOR", "STAT_THIRST_1_DESC", STAT_LONGEVITY, 1500, null );
        static { upgrades.add(STAT_THIRST_1); }
        // TODO asset: icons/upgrades/StatThirst2.png
        public static final Upgrade STAT_THIRST_2 = new Upgrade(111, "STAT_THIRST_2", "STAT_THIRST_2_FLAVOR", "STAT_THIRST_2_DESC", STAT_THIRST_1, 5000, null );
        static { upgrades.add(STAT_THIRST_2); }
        // TODO asset: icons/upgrades/StatThirst3.png
        public static final Upgrade STAT_THIRST_3 = new Upgrade(112, "STAT_THIRST_3", "STAT_THIRST_3_FLAVOR", "STAT_THIRST_3_DESC", STAT_THIRST_2, 15000, null );
        static { upgrades.add(STAT_THIRST_3); }
        // TODO asset: icons/upgrades/StatLogistics1.png
        public static final Upgrade STAT_LOGISTICS_1 = new Upgrade(113, "STAT_LOGISTICS_1", "STAT_LOGISTICS_1_FLAVOR", "STAT_LOGISTICS_1_DESC", ROLE_SCOUT, 600, null);
        static { upgrades.add(STAT_LOGISTICS_1); }
        // TODO asset: icons/upgrades/StatPassive1.png
        public static final Upgrade STAT_PASSIVE_1 = new Upgrade(114, "STAT_PASSIVE_1", "STAT_PASSIVE_1_FLAVOR", "STAT_PASSIVE_1_DESC", STAT_RESEARCH_3, 25000, null);
        static { upgrades.add(STAT_PASSIVE_1); }
        // TODO asset: icons/upgrades/StatLaying1.png
        public static final Upgrade STAT_LAYING_1 = new Upgrade(115, "STAT_LAYING_1", "STAT_LAYING_1_FLAVOR", "STAT_LAYING_1_DESC", ROLE_LAYER, 5000, null);
        static { upgrades.add(STAT_LAYING_1); }
        // TODO asset: icons/upgrades/StatLaying2.png
        public static final Upgrade STAT_LAYING_2 = new Upgrade(116, "STAT_LAYING_2", "STAT_LAYING_2_FLAVOR", "STAT_LAYING_2_DESC", STAT_LAYING_1, 15000, null);
        static { upgrades.add(STAT_LAYING_2); }
        // TODO asset: icons/upgrades/StatLaying3.png
        public static final Upgrade STAT_LAYING_3 = new Upgrade(117, "STAT_LAYING_3", "STAT_LAYING_3_FLAVOR", "STAT_LAYING_3_DESC", STAT_LAYING_2, 80000, null);
        static { upgrades.add(STAT_LAYING_3); }
        // TODO asset: icons/upgrades/StatScouting1.png
        public static final Upgrade STAT_SCOUTING_1 = new Upgrade(118, "STAT_SCOUTING_1", "STAT_SCOUTING_1_FLAVOR", "STAT_SCOUTING_1_DESC", ROLE_SCOUT, 4000, null);
        static { upgrades.add(STAT_SCOUTING_1); }
        // TODO asset: icons/upgrades/StatScouting2.png
        public static final Upgrade STAT_SCOUTING_2 = new Upgrade(119, "STAT_SCOUTING_2", "STAT_SCOUTING_2_FLAVOR", "STAT_SCOUTING_2_DESC", STAT_SCOUTING_1, 15000, null);
        static { upgrades.add(STAT_SCOUTING_2); }
        // TODO asset: icons/upgrades/StatScouting3.png
        public static final Upgrade STAT_SCOUTING_3 = new Upgrade(120, "STAT_SCOUTING_3", "STAT_SCOUTING_3_FLAVOR", "STAT_SCOUTING_3_DESC", STAT_SCOUTING_2, 35000, null);
        static { upgrades.add(STAT_SCOUTING_3); }
        // TODO asset: icons/upgrades/StatFarming1.png
        public static final Upgrade STAT_FARMING_1 = new Upgrade(121, "STAT_FARMING_1", "STAT_FARMING_1_FLAVOR", "STAT_FARMING_1_DESC", ROLE_FARMER, 4500, null);
        static { upgrades.add(STAT_FARMING_1); }
        // TODO asset: icons/upgrades/StatFarming2.png
        public static final Upgrade STAT_FARMING_2 = new Upgrade(122, "STAT_FARMING_2", "STAT_FARMING_2_FLAVOR", "STAT_FARMING_2_DESC", STAT_FARMING_1, 16000, null);
        static { upgrades.add(STAT_FARMING_2); }
        // TODO asset: icons/upgrades/StatFarming3.png
        public static final Upgrade STAT_FARMING_3 = new Upgrade(123, "STAT_FARMING_3", "STAT_FARMING_3_FLAVOR", "STAT_FARMING_3_DESC", STAT_FARMING_2, 60000, null);
        static { upgrades.add(STAT_FARMING_3); }
        // TODO asset: icons/upgrades/StatContamination1.png
        public static final Upgrade STAT_CONTAMINATION_1 = new Upgrade(124, "STAT_CONTAMINATION_1", "STAT_CONTAMINATION_1_FLAVOR", "STAT_CONTAMINATION_1_DESC", ROLE_GRAVER, 2000, null);
        static { upgrades.add(STAT_CONTAMINATION_1); }
        // TODO asset: icons/upgrades/StatContamination2.png
        public static final Upgrade STAT_CONTAMINATION_2 = new Upgrade(125, "STAT_CONTAMINATION_2", "STAT_CONTAMINATION_2_FLAVOR", "STAT_CONTAMINATION_2_DESC", STAT_CONTAMINATION_1, 8000, null);
        ...
        public static final Upgrade STAT_GRAVING_3 = new Upgrade(129, "STAT_GRAVING_3", "STAT_GRAVING_3_FLAVOR", "STAT_GRAVING_3_DESC", STAT_GRAVING_2, 40000, null);
        static { upgrades.add(STAT_GRAVING_3); }
        // TODO asset: icons/upgrades/StatPolicing1.png
        public static final Upgrade STAT_POLICING_1 = new Upgrade(130, "STAT_POLICING_1", "STAT_POLICING_1_FLAVOR", "STAT_POLICING_1_DESC", ROLE_POLICE, 3000, null);
        static { upgrades.add(STAT_POLICING_1); }
        // TODO asset: icons/upgrades/StatPolicing2.png
        public static final Upgrade STAT_POLICING_2 = new Upgrade(131, "STAT_POLICING_2", "STAT_POLICING_2_FLAVOR", "STAT_POLICING_2_DESC", STAT_POLICING_1, 14000, null);
        ...
        public static final Building MUSHROOM_CHAMBER_0 = new Building(3, "MUSHROOM_CHAMBER_0", 0, "MUSHROOM_CHAMBER_0_DESC", null, 0, 0, 0,
                GameConstants.ROOM_MUSHROOM_L0);
        ...
        public static final Building MUSHROOM_CHAMBER_1 = new Building(12, "MUSHROOM_CHAMBER_1", 1, "MUSHROOM_CHAMBER_1_DESC", MUSHROOM_CHAMBER_0, 0, 0, 150,
                GameConstants.ROOM_MUSHROOM_L1);
        ...
        public static final Building MUSHROOM_CHAMBER_2 = new Building(21, "MUSHROOM_CHAMBER_2", 2, "MUSHROOM_CHAMBER_2_DESC", MUSHROOM_CHAMBER_1, 250, 0, 800,
                GameConstants.ROOM_MUSHROOM_L2);
        ...
        public static final Building MUSHROOM_CHAMBER_3 = new Building(30, "MUSHROOM_CHAMBER_3", 3, "MUSHROOM_CHAMBER_3_DESC", MUSHROOM_CHAMBER_2, 800, 0, 5000,
                GameConstants.ROOM_MUSHROOM_L3);
        ...
        public static final Building PASSIVE_LAB = new Building(101, "PASSIVE_LAB", 0, "PASSIVE_LAB_DESC", ROYAL_CHAMBER_1, 150, 0, 800,
                GameConstants.ROOM_PASSIVE_LAB);
        ...
        public static final Building PASSIVE_WATER = new Building(102, "PASSIVE_WATER", 0, "PASSIVE_WATER_DESC", WATER_RESERVOIR_1, 100, 0, 500,
                GameConstants.ROOM_PASSIVE_WATER);
        ...
        public static final Building PASSIVE_APHID = new Building(103, "PASSIVE_APHID", 0, "PASSIVE_APHID_DESC", SYRUP_RESERVOIR_1, 200, 0, 1000,
                GameConstants.ROOM_PASSIVE_APHID);
        ...
        public static final Building PASSIVE_NURSE = new Building(104, "PASSIVE_NURSE", 0, "PASSIVE_NURSE_DESC", EGG_CHAMBER_1, 150, 0, 700,
                GameConstants.ROOM_PASSIVE_NURSE);
        ...
        public static final Building PASSIVE_FARM = new Building(105, "PASSIVE_FARM", 0, "PASSIVE_FARM_DESC", MUSHROOM_CHAMBER_1, 200, 0, 900,
                GameConstants.ROOM_PASSIVE_FARM);
        ...
        public static final Building PASSIVE_GRAVE = new Building(106, "PASSIVE_GRAVE", 0, "PASSIVE_GRAVE_DESC", MEAT_CHAMBER_1, 150, 0, 600,
                GameConstants.ROOM_PASSIVE_GRAVE);
        ...
        public static final Building BUILDING_COMPOSTER = new Building(107, "BUILDING_COMPOSTER", 0, "BUILDING_COMPOSTER_DESC", PASSIVE_GRAVE, 500, 0, 1000,
                GameConstants.ROOM_PASSIVE_COMPOSTER);
