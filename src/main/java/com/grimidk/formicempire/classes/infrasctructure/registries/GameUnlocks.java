...
public final class GameUnlocks {
    ...
    // --- Buildings ---
    // Room/menu sprites: TODO asset on GameConstants.buildingRoomSprite / passiveBuildingRoomSprite
    // (sprites/buildings/rooms/{Chain}L{tier}.png and Passive{Name}.png — see BuildingSpriteResources)
    // -- Tier 0 --
