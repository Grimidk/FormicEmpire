...
public class SpanishTranslation implements Translation {
    ...
    public Map<String, String> getStrings() {
        ...
        es.put("SPECIES_TURTLE_SCIENTIFIC", "Cephalotes Sp.");
        es.put("SPECIES_CARPENTER", "Hormiga Carpintera");
        es.put("SPECIES_CARPENTER_SCIENTIFIC", "Camponotus Sp.");
        es.put("SPECIES_WEAVER", "Hormiga Tejedora");
        es.put("SPECIES_WEAVER_SCIENTIFIC", "Oecophylla Sp.");
        ...
        es.put("SPECIES_BULLDOG_SCIENTIFIC", "Myrmecia Sp.");
