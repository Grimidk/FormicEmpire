...
public class SpanishTranslation implements Translation {
    ...
    public Map<String, String> getStrings() {
        ...
        es.put("TAB_RESEARCH_AVAILABLE", "Disponibles");
        es.put("TAB_TRIGGERS", "Disparadores");
        ...
        es.put("TRIGGER_PROGRESS_NONE", "Aún no hay progreso de disparadores. Sigue expandiendo, investigando y explorando para revelar objetivos.");
        es.put("TRIGGER_PROGRESS_SHOW_COMPLETED", "Mostrar completados");
        es.put("TRIGGER_PROGRESS_STATUS_UNLOCKED", "Desbloqueado");
        es.put("TRIGGER_PROGRESS_STATUS_PARTIAL", "En progreso (%s/%s)");
        es.put("TRIGGER_PROGRESS_METRIC_FMT", "%s: %s / %s");
        es.put("TRIGGER_PROGRESS_METRIC_MONTHS", "Meses transcurridos");
        es.put("TRIGGER_PROGRESS_METRIC_CORPSES", "Hormigas muertas");
        es.put("TRIGGER_PROGRESS_METRIC_RP", "Puntos de investigación");
        es.put("TRIGGER_PROGRESS_METRIC_POPULATION", "Umbral de rango de colonia");
        es.put("TRIGGER_PROGRESS_METRIC_COLONIES", "Colonias");
        es.put("TRIGGER_PROGRESS_METRIC_NUPTIALS", "Vuelos nupciales");
        es.put("TRIGGER_PROGRESS_METRIC_TRADES", "Comercios activos");
        es.put("TRIGGER_PROGRESS_METRIC_TUNNELS", "Túneles completados");
        es.put("TRIGGER_PROGRESS_METRIC_DIPLOMATS", "Diplomáticas enviadas");
        es.put("TRIGGER_PROGRESS_METRIC_ABSORBED", "Dinastías absorbidas");
        es.put("TRIGGER_PROGRESS_METRIC_WARS", "Guerras participadas");
        ...
        es.put("TRIGGER_PROGRESS_HINT_POLICE", "Crece hasta un rango de colonia mayor para desbloquear policía.");
        es.put("TRIGGER_PROGRESS_HINT_COLONIES", "Fundar más colonias con vuelos nupciales y el mapa mundial.");
        es.put("TRIGGER_PROGRESS_HINT_NUPTIALS", "Lanza vuelos nupciales desde colonias con zánganos y reproductoras.");
        es.put("TRIGGER_PROGRESS_HINT_TRADES", "Establece rutas comerciales activas entre colonias.");
        es.put("TRIGGER_PROGRESS_HINT_TUNNELS", "Completa túneles entre colonias de la dinastía. Requiere Automatización primero.");
        es.put("TRIGGER_PROGRESS_HINT_DIPLOMATS", "Envía diplomáticas en misiones de lealtad o reputación. Requiere Automatización primero.");
        es.put("TRIGGER_PROGRESS_HINT_ABSORBED", "Derrota y absorbe otra dinastía.");
        es.put("TRIGGER_PROGRESS_HINT_COMMANDER", "Participa en guerras y mantén más de una reina en una colonia para desbloquear Comandante.");
        ...
        es.put("HATCH_SUBTYPE_HEAD_SECTION", "Subtipos de cabeza:");
        es.put("HATCH_SUBTYPE_ABDOMEN_SECTION", "Subtipos de abdomen:");
        es.put("HATCH_SUBTYPE_ROW_TOTAL", "Total fila");
        es.put("SUBTYPE_FOOD_COST_PER_TRAIT", "(+50% consumo de alimento por parte activa del subtipo)");
        ...
        es.put("SKILL_POWERFUL_BITE", "Mordida poderosa");
        es.put("SKILL_STINGING", "Aguijón");
        es.put("SKILL_SHIELDING", "Escudo");
        ...
        es.put("BATTLE_LINE_AIR_SUPPORT", "Apoyo aéreo");
        ...
        es.put("STATS_TAB_WORLD_HISTORY", "Historia del Mundo");
        es.put("STAT_BIRTH_RATE", "Tasa de natalidad");
        es.put("HISTORY_FILTER_ALL", "Todos los eventos");
        es.put("HISTORY_FILTER_OWN_ONLY", "Solo mi dinastía");
        es.put("HISTORY_FILTER_COLONY", "Colonias");
        es.put("HISTORY_FILTER_DYNASTY", "Dinastías");
        es.put("HISTORY_FILTER_WAR", "Guerras");
        es.put("HISTORY_FILTER_BATTLE", "Batallas");
        es.put("HISTORY_FILTER_REBELLION", "Rebeliones");
        es.put("HISTORY_FILTER_NUPTIAL", "Vuelos nupciales");
        es.put("HISTORY_FILTER_ASSIMILATION", "Asimilaciones");
        es.put("HISTORY_COL_DATE", "Fecha");
        es.put("HISTORY_COL_CATEGORY", "Categoría");
        es.put("HISTORY_COL_EVENT", "Evento");
        es.put("HISTORY_EMPTY", "Aún no hay historia del mundo registrada.");
        es.put("HISTORY_UNKNOWN_DYNASTY_FMT", "Dinastía #%s");
        es.put("HISTORY_UNKNOWN_COLONY_FMT", "Colonia #%s");
        es.put("HISTORY_UNKNOWN_ASSIMILATION_FMT", "Asimilación #%s");
        es.put("HISTORY_COLONY_FOUNDED_FMT", "%s fundada por %s");
        es.put("HISTORY_COLONY_DIED_FMT", "%s de %s colapsó (%s)");
        es.put("HISTORY_DYNASTY_FORMED_FMT", "%s fue fundada");
        es.put("HISTORY_DYNASTY_DIED_FMT", "%s cayó (%s)");
        es.put("HISTORY_DYNASTY_ABSORBED_FMT", "%s absorbió a %s");
        es.put("HISTORY_DYNASTY_RANK_UP_FMT", "%s ascendió de %s a %s");
        es.put("HISTORY_CAPITAL_MOVED_FMT", "%s coronó nueva capital: %s");
        es.put("HISTORY_WAR_STARTED_FMT", "%s declaró la guerra a %s (guerra #%s)");
        es.put("HISTORY_WAR_ENDED_FMT", "Guerra #%s terminó — ganador: %s (%s)");
        es.put("HISTORY_BATTLE_FMT", "%s ganó una batalla en %s (guerra #%s)");
        es.put("HISTORY_BATTLE_CAPTURE_FMT", "%s capturó %s (guerra #%s)");
        es.put("HISTORY_REBELLION_FORMED_FMT", "%s se rebeló de %s con %s colonias");
        es.put("HISTORY_REBELLION_FIGHT_FMT", "%s eligió luchar contra la rebelión de %s");
        es.put("HISTORY_REBELLION_INDEPENDENCE_FMT", "%s concedió independencia a %s");
        es.put("HISTORY_NUPTIAL_FLIGHT_FMT", "Vuelo nupcial en %s (+%s reinas, %s partieron a fundar)");
        es.put("HISTORY_ASSIMILATION_COMPLETED_FMT", "%s completó la asimilación: %s");
        es.put("HISTORY_CAUSE_NO_QUEEN", "sin reina");
        es.put("HISTORY_CAUSE_ZERO_ANTS", "sin hormigas vivas");
        es.put("HISTORY_CAUSE_ALL_COLONIES_DEAD", "todas las colonias muertas");
        es.put("HISTORY_CAUSE_EXTINCT", "extinta");
        es.put("HISTORY_CAUSE_EXTINCT_DEHYDRATION", "extinta (deshidratación)");
        es.put("HISTORY_CAUSE_EXTINCT_EXHAUSTION", "extinta (agotamiento de recursos)");
        ...
        es.put("DYNASTY_DEFAULT_AUTO_TUNNELS_TOOLTIP", "Activa Auto-Túneles en colonias nuevas.");
        ...
        es.put("STAT_SUBTYPE_FOOD_OVERHEAD", "Extra de alimento por subtipos");
        ...
        es.put("MAP_HOME_BUTTON", "Volver al Hogar");
        ...
        es.put("WAR_STAGE_WON_TITLE", "Batalla ganada");
        es.put("WAR_STAGE_LOST_TITLE", "Batalla perdida");
        ...
        es.put("BATTLE_PHASE_CLASH", "Choque fronterizo");
        es.put("BATTLE_PHASE_RESERVE", "Asedio de colonia");
        ...
        es.put("STAT_COMBAT_CAPACITY_DESC", "Cuántos combatientes puede desplegar tu dinastía como activos por línea de batalla. Empieza en 1.000; asignar una Reina como Comandante (máx. 1 por colonia; requiere otra reina fuera de combate) la sube a 2.500 una sola vez. El resto queda en reserva y entra a la línea cuando caen activos.");
        ...
        es.put("CITY_TITLE_CITY", "Ciudad");
        es.put("CITY_TITLE_BERG", "Berg");
        es.put("CITY_TITLE_GRAD", "Grad");
        es.put("CITY_TITLE_BURG", "Burg");
        es.put("CITY_TITLE_HAVEN", "Refugio");
        es.put("CITY_TITLE_NEST", "Nido");
        es.put("CITY_TITLE_HOLD", "Bastión");
        es.put("CITY_TITLE_FORD", "Vado");
        es.put("CITY_TITLE_FORT", "Fuerte");
        ...
        es.put("DYNASTY_THEME_PLAYER", "Jugador");
        es.put("DYNASTY_THEME_OMNI", "Omni");
        es.put("DYNASTY_THEME_ANT", "Hormiga");
        es.put("DYNASTY_THEME_LEAF", "Hoja");
        es.put("DYNASTY_THEME_PLANT", "Planta");
        es.put("DYNASTY_THEME_SEED", "Semilla");
        es.put("DYNASTY_THEME_PHARAOH", "Faraón");
        es.put("DYNASTY_THEME_RUBY", "Rubí");
        es.put("DYNASTY_THEME_TOPAZ", "Topacio");
        es.put("DYNASTY_THEME_MARAUDER", "Merodeador");
        es.put("DYNASTY_THEME_SCORPION", "Escorpión");
        es.put("DYNASTY_THEME_COCKROACH", "Cucaracha");
        es.put("DYNASTY_THEME_TRAPJAW", "Mandíbula");
        es.put("DYNASTY_THEME_TRAP", "Trampa");
        es.put("DYNASTY_THEME_JAW", "Mandíbula");
        es.put("DYNASTY_THEME_HONEYPOT", "Tarro");
        es.put("DYNASTY_THEME_HONEY", "Miel");
        es.put("DYNASTY_THEME_BEE", "Abeja");
        es.put("DYNASTY_THEME_TURTLE", "Tortuga");
        es.put("DYNASTY_THEME_SHELL", "Caparazón");
        es.put("DYNASTY_THEME_TORTOISE", "Tortuga");
        es.put("DYNASTY_THEME_CARPENTER", "Carpintero");
        es.put("DYNASTY_THEME_WOOD", "Madera");
        es.put("DYNASTY_THEME_TREE", "Árbol");
        es.put("DYNASTY_THEME_WEAVER", "Tejedor");
        es.put("DYNASTY_THEME_SILK", "Seda");
        es.put("DYNASTY_THEME_SPIDER", "Araña");
        es.put("DYNASTY_THEME_FLOODPLAIN", "Vega");
        es.put("DYNASTY_THEME_RIVER", "Río");
        es.put("DYNASTY_THEME_WATER", "Agua");
        es.put("DYNASTY_THEME_FIRE", "Fuego");
        es.put("DYNASTY_THEME_FLAME", "Llama");
        es.put("DYNASTY_THEME_BURN", "Quema");
        es.put("DYNASTY_THEME_JET", "Jet");
        es.put("DYNASTY_THEME_TORNADO", "Tornado");
        es.put("DYNASTY_THEME_WIND", "Viento");
        es.put("DYNASTY_THEME_BULLET", "Bala");
        es.put("DYNASTY_THEME_STING", "Aguijón");
        es.put("DYNASTY_THEME_PUNCH", "Puñetazo");
        es.put("DYNASTY_THEME_ARMY", "Ejército");
        es.put("DYNASTY_THEME_SOLDIER", "Soldado");
        es.put("DYNASTY_THEME_WARRIOR", "Guerrero");
        es.put("DYNASTY_THEME_GHOST", "Fantasma");
        es.put("DYNASTY_THEME_SHADOW", "Sombra");
        es.put("DYNASTY_THEME_PHANTOM", "Fantasma");
        es.put("DYNASTY_THEME_DRACULA", "Drácula");
        es.put("DYNASTY_THEME_VAMPIRE", "Vampiro");
        es.put("DYNASTY_THEME_BLOOD", "Sangre");
        es.put("DYNASTY_THEME_SILVER", "Plata");
        es.put("DYNASTY_THEME_METAL", "Metal");
        es.put("DYNASTY_THEME_GOLD", "Oro");
        es.put("DYNASTY_THEME_MARICOPA", "Maricopa");
        es.put("DYNASTY_THEME_VENOM", "Veneno");
        es.put("DYNASTY_THEME_POISON", "Veneno");
        es.put("DYNASTY_THEME_EXPLODING", "Explosivo");
        es.put("DYNASTY_THEME_BOMB", "Bomba");
        es.put("DYNASTY_THEME_EXPLOSION", "Explosión");
        es.put("DYNASTY_THEME_BULLDOG", "Bulldog");
        es.put("DYNASTY_THEME_DOG", "Perro");
        es.put("DYNASTY_THEME_HOUND", "Sabueso");
        es.put("DYNASTY_THEME_SHINING", "Brillante");
        es.put("DYNASTY_THEME_BLACK", "Negro");
        es.put("DYNASTY_THEME_DARK", "Oscuro");
        es.put("DYNASTY_THEME_DESERT", "Desierto");
        es.put("DYNASTY_THEME_SAND", "Arena");
        es.put("DYNASTY_THEME_DIRT", "Tierra");
        es.put("DYNASTY_THEME_LEAFCUTTER", "Cortadora");
        es.put("DYNASTY_THEME_ROCK", "Roca");
        es.put("DYNASTY_THEME_IRON", "Hierro");
        es.put("DYNASTY_THEME_MUSHROOM", "Hongo");
        es.put("DYNASTY_THEME_MEAT", "Carne");
        es.put("DYNASTY_THEME_BUG", "Bicho");
        es.put("DYNASTY_THEME_STONE", "Piedra");
        es.put("DYNASTY_THEME_CLAY", "Arcilla");
        es.put("DYNASTY_THEME_STEEL", "Acero");
        es.put("DYNASTY_THEME_ICE", "Hielo");
        es.put("DYNASTY_THEME_STORM", "Tormenta");
        es.put("DYNASTY_THEME_DUST", "Polvo");
        es.put("DYNASTY_THEME_VINE", "Enredadera");
        es.put("DYNASTY_THEME_ROOT", "Raíz");
        es.put("DYNASTY_THEME_POLLEN", "Polen");
        es.put("DYNASTY_THEME_WEB", "Telaraña");
        es.put("DYNASTY_THEME_NIGHT", "Noche");
        es.put("DYNASTY_THEME_DAY", "Día");
        es.put("DYNASTY_THEME_COPPER", "Cobre");
        es.put("DYNASTY_THEME_BRONZE", "Bronce");
        es.put("DYNASTY_THEME_EMERALD", "Esmeralda");
        es.put("DYNASTY_THEME_GREEN", "Verde");
        es.put("DYNASTY_THEME_ACID", "Ácido");
        es.put("DYNASTY_THEME_SAPPHIRE", "Zafiro");
        es.put("DYNASTY_THEME_QUARTZ", "Cuarzo");
        es.put("DYNASTY_THEME_GRANITE", "Granito");
        es.put("DYNASTY_THEME_SWAMP", "Pantano");
        es.put("DYNASTY_THEME_MARSH", "Ciénaga");
        es.put("DYNASTY_THEME_OCEAN", "Océano");
        es.put("DYNASTY_THEME_PEAK", "Cumbre");
        es.put("DYNASTY_THEME_VALLEY", "Valle");
        es.put("DYNASTY_THEME_CAVE", "Cueva");
        es.put("DYNASTY_THEME_FOREST", "Bosque");
        es.put("DYNASTY_THEME_JUNGLE", "Selva");
        ...
        es.put("SETTINGS_LANGUAGE_TT", "Idioma de menús, diálogos y textos del juego.");
        es.put("SETTINGS_AUTOSAVE_TT", "Con qué frecuencia el juego guarda automáticamente. Desactivado deshabilita el autoguardado.");
        es.put("SETTINGS_TURBO_TT", "Desbloquea el nivel Turbo en la barra de control (tick más rápido).");
        es.put("SETTINGS_ARACHNOPHOBIA_TT", "Sustituye los enemigos con aspecto de araña por una apariencia menos realista.");
        es.put("SETTINGS_PAUSE_FOCUS_TT", "Pausa el juego automáticamente cuando la ventana pierde el foco.");
        es.put("SETTINGS_CONFIRM_QUIT_TT", "Muestra una confirmación antes de salir durante una partida activa.");
        es.put("SETTINGS_ESCAPE_KEY_GAME_ACTIONS_TT", "Si está activo, Esc cierra el diálogo superior o abre el menú del juego.");
        es.put("SETTINGS_SHOW_TOOLTIPS_TT", "Muestra consejos al pasar el cursor sobre botones y controles del juego.");
        es.put("SETTINGS_OVERWORLD_AUTO_RECENTER_TT", "En el exterior, recentra suavemente la vista en la entrada de la colonia cuando estás inactivo.");
        es.put("SETTINGS_FUZZ_PARASITE_ANTS_TT", "Muestra cifras aproximadas de hormigas parásitas en lugar de números exactos.");
        es.put("SETTINGS_SHOW_AUDIT_MENU_TT", "Añade una entrada de Auditoría de mecánicas al menú principal y al menú Esc del juego.");
        es.put("SETTINGS_SCREEN_SIZE_TT", "Tamaño de ventana sin pantalla completa. Guardar y aplicar; vuelve a abrir ajustes para redimensionar.");
        es.put("SETTINGS_FULLSCREEN_TT", "Ejecuta en una ventana maximizada sin bordes. Guardar y aplicar para que surta efecto.");
        ...
        es.put("SETTINGS_DEFAULT_ROLE_WORKER_TT", "Función asignada al eclosionar nuevas obreras.");
        es.put("SETTINGS_DEFAULT_ROLE_SOLDIER_TT", "Función asignada al eclosionar nuevas soldadas.");
        es.put("SETTINGS_DEFAULT_ROLE_MAJOR_TT", "Función asignada al eclosionar nuevas mayores.");
        es.put("SETTINGS_DEFAULT_ROLE_PRINCESS_TT", "Función asignada al eclosionar nuevas princesas.");
        es.put("SETTINGS_DEFAULT_ROLE_QUEEN_TT", "Función asignada al eclosionar nuevas reinas.");
        ...
        es.put("CRITTER_CLASS_AMPHIBIAN", "Anfibio");
        es.put("CRITTER_CLASS_BIRD", "Ave");
        ...
        es.put("TIER_0", "Tier 0");
        es.put("TIER_1", "Tier 1");
        es.put("TIER_2", "Tier 2");
        es.put("TIER_3", "Tier 3");
        es.put("TIER_4", "Tier 4");
        es.put("TIER_5", "Tier 5");
        es.put("TIER_6", "Tier 6");
        es.put("TIER_7", "Tier 7");
        es.put("TIER_8", "Tier 8");
        es.put("TIER_9", "Tier 9");
        es.put("TIER_10", "Tier 10");
        es.put("TIER_11", "Tier 11");
        ...
        es.put("DIPLO_MODIFIER_TRADE_OFFER", "Oferta comercial");
        ...
        es.put("DIPLO_MODIFIER_WARMONGER", "Belicista");
        ...
        es.put("LOYALTY_MODIFIER_RECENTLY_INTEGRATED", "Recién integrada");
        ...
        es.put("DIPLO_INTEGRATION_VASSAL_WAR_ALERT_TITLE", "Objetivo de integración atacado");
        es.put("DIPLO_INTEGRATION_VASSAL_WAR_ALERT_FMT", "%s ha declarado la guerra contra %s, a quien estás integrando. Tu dinastía ha asumido la guerra.");
        es.put("DIPLO_INTEGRATION_COMPLETED_TITLE", "Integración completada");
        es.put("DIPLO_INTEGRATION_COMPLETED_MSG_FMT", "%s se ha integrado por completo en tu dinastía.");
        ...
        es.put("DIPLO_ERROR_WAR_ACTIVE_MILITARY", "Asigna roles militares activos en la economía de guerra (Guerrera, Defensora, Milicia, Bruto o Comandante) antes de declarar la guerra.");
        ...
        es.put("DIPLO_INTEGRATION_PROGRESS_TOOLTIP_FMT", "Integración: %s%% completa, finaliza %s, %s diplomáticas asignadas");
        es.put("DIPLO_ACTION_MANAGE_INTEGRATION_DIPLOMATS", "Gestionar diplomáticas de integración");
        es.put("DIPLO_INTEGRATION_DIPLOMATS_PROMPT", "Asigna diplomáticas a la integración (hasta %s disponibles en la dinastía).");
        es.put("DIPLO_INTEGRATION_STANCE", "Integrando");
        es.put("DIPLO_INTEGRATION_STARTED_FMT", "Comenzó la integración de %s.");
        es.put("DIPLO_INTEGRATION_CANCEL_CONFIRM_FMT", "¿Cancelar la integración de %s? Se perderá el progreso.");
        es.put("DIPLO_ERROR_INTEGRATION_ACTIVE", "Solo puede haber una integración a la vez.");
        es.put("DIPLO_ERROR_INTEGRATION_TARGET_BUSY", "Esa dinastía ya está siendo integrada.");
        ...
        es.put("SPECIES_TRAPJAW_SCIENTIFIC", "Odontomachus Hastatus");
        es.put("SPECIES_HONEYPOT", "Hormiga Mielera");
        es.put("SPECIES_HONEYPOT_SCIENTIFIC", "Camponotus Inflatus");
        es.put("SPECIES_TURTLE", "Hormiga Tortuga");
        es.put("SPECIES_TURTLE_SCIENTIFIC", "Cephalotes Atratus");
        es.put("SPECIES_CARPENTER", "Hormiga Carpintera");
        es.put("SPECIES_CARPENTER_SCIENTIFIC", "Camponotus Pennsylvanicus");
        es.put("SPECIES_WEAVER", "Hormiga Tejedora");
        es.put("SPECIES_WEAVER_SCIENTIFIC", "Oecophylla Smaragdina");
        es.put("SPECIES_FLOODPLAIN", "Hormiga de Llanura Inundable");
        es.put("SPECIES_FLOODPLAIN_SCIENTIFIC", "Formica Selysi");
        es.put("SPECIES_FIRE", "Hormiga de Fuego");
        es.put("SPECIES_FIRE_SCIENTIFIC", "Solenopsis Invicta");
        es.put("SPECIES_JET", "Hormiga Jet");
        es.put("SPECIES_JET_SCIENTIFIC", "Harpegnathos Saltator");
        es.put("SPECIES_BULLET", "Hormiga Bala");
        es.put("SPECIES_BULLET_SCIENTIFIC", "Paraponera Clavata");
        es.put("SPECIES_ARMY", "Hormiga Ejército");
        es.put("SPECIES_ARMY_SCIENTIFIC", "Eciton Burchellii");
        es.put("SPECIES_GHOST", "Hormiga Fantasma");
        es.put("SPECIES_GHOST_SCIENTIFIC", "Tapinoma Melanocephalum");
        es.put("SPECIES_DRACULA", "Hormiga Drácula");
        es.put("SPECIES_DRACULA_SCIENTIFIC", "Mystrium Camillae");
        es.put("SPECIES_SILVER", "Hormiga Plateada del Sahara");
        es.put("SPECIES_SILVER_SCIENTIFIC", "Cataglyphis Bicolor");
        ...
        es.put("SPECIES_BULLDOG_SCIENTIFIC", "Myrmecia Pyriformis");
        es.put("SPECIES_SHININGBLACK", "Hormiga Negra Brillante");
        es.put("SPECIES_SHININGBLACK_SCIENTIFIC", "Lasius Fuliginosus");
        ...
        es.put("ASSIMILATION_TRAPJAW", "Mandíbula-trampa");
        ...
        es.put("ASSIMILATION_HONEYPOT", "Honeypot");
        ...
        es.put("ASSIMILATION_DOORHEAD", "Doorhead");
        ...
        es.put("ASSIMILATION_WOODBURROW", "Excavación en madera");
        ...
        es.put("ASSIMILATION_SILKWEAVE", "Tejido de seda");
        ...
        es.put("ASSIMILATION_RAFTING", "Balsas");
        ...
        es.put("ASSIMILATION_FIREVENOM", "Veneno de fuego");
        ...
        es.put("ASSIMILATION_JUMPING", "Salto");
        ...
        es.put("ASSIMILATION_STINGING", "Aguijón");
        ...
        es.put("ASSIMILATION_SWARMING", "Enjambre");
        ...
        es.put("ASSIMILATION_STEALTH", "Sigilo");
        ...
        es.put("ASSIMILATION_FASTBITE", "Mordida rápida");
        ...
        es.put("ASSIMILATION_HEATRESIST", "Resistencia al calor");
        ...
        es.put("ASSIMILATION_DEADLYVENOM", "Veneno mortal");
        ...
        es.put("ASSIMILATION_SELFDESTRUCT", "Autodestrucción");
        ...
        es.put("ASSIMILATION_FARSIGHT", "Vista lejana");
        ...
        es.put("ASSIMILATION_HIVEBUILD", "Construcción de nido");
        ...
        es.put("ASSIMILATION_LOCSENSE", "Sentido de ubicación");
        ...
        es.put("ABILITY_AUTO_TUNNELS", "Auto-Túneles");
        es.put("ABILITY_AUTO_TUNNELS_FLAVOR", "Auto-Túneles");
        ...
        es.put("ABILITY_AUTO_DIPLOMACY", "Auto-Diplomacia");
        es.put("ABILITY_AUTO_DIPLOMACY_FLAVOR", "Auto-Diplomacia");
        ...
        es.put("ABILITY_SUBTYPE_HATCH_FLAVOR", "Tasas de subtipos morfológicos");
        es.put("ABILITY_SUBTYPE_HATCH_DESC", "Ajusta las probabilidades de subtipos de cabeza y abdomen por tipo de hormiga en Tasas de eclosión (P).");
        ...
        es.put("ABILITY_CLONING_DESC", "Activa la ganancia de integridad genética por asimilaciones completadas (+5% de suelo cada una) y muestra zánganos de especies asimiladas en tu colonia. Las colonias satélite siguen reduciendo la integridad genética.");
        ...
        es.put("ABILITY_DIPLOMAT_PRESSURE_3_DESC", "Cada diplomática enviada mejora la estabilidad en 5 en lugar de 3.");
        ...
        es.put("HELP_UI_BAR_TITLE", "Barra de control en juego");
        es.put("HELP_UI_SPEEDS_TITLE", "Iconos de velocidad");
        es.put("HELP_UI_SPEED_PAUSED", "Pausado");
        es.put("HELP_UI_SPEED_MS", "%s ms por tick");
        ...
        es.put("HOTKEY_X", "Estadísticas — pestañas incluyen Historia del Mundo, economía, población (alternar)");
        ...
        es.put("HELP_TUTORIAL_DYNASTY", "<b>Dinastía:</b><br><br>Desbloquea Princesas <b>Criadoras</b> para fundar colonias en el <b>Mapa Mundial (M)</b>.<br><i>¡Los eclipses pueden activar Vuelos Nupciales gratuitos!</i><br><br>Las pestañas de dinastía están disponibles desde el inicio: <b>A</b> Resumen, <b>S</b> Comercio, <b>D</b> Diplomacia, <b>F</b> Guerras (ESC → submenú Dinastía). Declara la guerra desde Diplomacia; sigue las campañas en la pestaña Guerras.");
        ...
        es.put("HELP_MILITARY_POWER_BODY", "Tipos adultos (sin roles): Obrera×1, Soldado×5, Mayor×15, Princesa×10, Reina×50.<br>Escalado por Esqueleto + Ácido. Se recalcula cada día del mundo.<br>Grandes brechas de poder inclinan diplomacia y lealtad hacia el más fuerte.");
        ...
        es.put("LOG_INTEGRATION_STARTED_FMT", "Comenzó la integración de %s.");
        es.put("LOG_INTEGRATION_COMPLETED_FMT", "Se integró %s en la dinastía.");
        es.put("LOG_INTEGRATION_CANCELLED_FMT", "La integración de %s terminó: ya no se cumplen los requisitos.");
        es.put("LOG_INTEGRATION_CANCELLED_PLAYER_FMT", "Se canceló la integración de %s.");
        ...
        es.put("DYNASTY_SORT_REPUTATION_HIGH", "Reputación (mayor primero)");
        es.put("DYNASTY_SORT_DISTANCE_NEAR", "Distancia (más cercana primero)");
        es.put("DYNASTY_SORT_DISTANCE_FAR", "Distancia (más lejana primero)");
        es.put("DYNASTY_SEARCH", "Buscar:");
        es.put("DYNASTY_SEARCH_TOOLTIP", "Filtrar por nombre de dinastía o colonia");
        es.put("COLONY_SEARCH_TOOLTIP", "Filtrar por nombre de colonia");
        ...
        es.put("TRIGGER_CLONING_MSG", "¡Tu colonia ha alcanzado el rango Imperio! Clonación desbloqueada: las asimilaciones suben el suelo de integridad genética y aparecen zánganos de especies asimiladas.");
        ...
        es.put("TRIGGER_RANK_ULTRA_MSG", "¡Ultracolonia alcanzada! Tus números remodelan la tierra y se desbloquean avances de nivel ultra.");
        es.put("TRIGGER_RANK_HYPER_TITLE", "Hipercolonia");
        es.put("TRIGGER_RANK_HYPER_MSG", "¡Estatus de Hipercolonia! La densidad del enjambre desbloquea mejoras y edificios de nivel hiper.");
        es.put("TRIGGER_RANK_MEGA_TITLE", "Megacolonia");
        es.put("TRIGGER_RANK_MEGA_MSG", "¡Megacolonia! La masa de tu dinastía es legendaria y abre avances de nivel mega.");
        es.put("TRIGGER_RANK_ULTIMATE_TITLE", "Colonia Definitiva");
        es.put("TRIGGER_RANK_ULTIMATE_MSG", "¡Colonia Definitiva! Pocos enjambres llegan tan alto: las opciones de nivel definitivo ya están desbloqueadas.");
        es.put("TRIGGER_RANK_SUPREME_TITLE", "Colonia Suprema");
        es.put("TRIGGER_RANK_SUPREME_MSG", "¡Colonia Suprema! Tu dinastía se alza entre las mayores, con tecnología de nivel supremo disponible.");
        es.put("TRIGGER_RANK_GIGA_TITLE", "Giga Colonia");
        es.put("TRIGGER_RANK_GIGA_MSG", "¡Giga Colonia, el rango máximo! Los últimos niveles de mejoras y edificios están a tu alcance.");
        ...
        es.put("TRIGGER_SCOUT_ROLE_MSG", "¡Nuestras recolectoras han cosechado suficiente de una fuente de plantas! Las obreras sienten la necesidad de explorar nuevas tierras, desbloqueando el rol de Explorador.");
        ...
        es.put("TRIGGER_AUTO_TUNNELS_TITLE", "Auto-Túneles");
        es.put("TRIGGER_AUTO_TUNNELS_MSG", "¡Tu dinastía ha completado %s túneles! Las colonias automatizadas pueden excavar cada enlace restante. Activa Auto-Túneles por colonia en la Vista general de la Dinastía (A).");
        es.put("TRIGGER_AUTO_DIPLOMACY_TITLE", "Auto-Diplomacia");
        es.put("TRIGGER_AUTO_DIPLOMACY_MSG", "¡Tu dinastía ha enviado %s misiones diplomáticas! La capital y las colonias militantes pueden estabilizar la lealtad automáticamente. Activa Auto-Diplomacia en la Vista general de la Dinastía (A).");
