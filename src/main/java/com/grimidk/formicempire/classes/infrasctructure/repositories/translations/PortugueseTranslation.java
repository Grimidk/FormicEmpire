...
public class PortugueseTranslation implements Translation {
    ...
    public Map<String, String> getStrings() {
        ...
        pt.put("COLONY_MILITARY_POWER", "Poder militar: %,d");
        ...
        pt.put("LOYALTY_MODIFIER_DISTANCE_LINE", "%s (%d casas): %+d");
