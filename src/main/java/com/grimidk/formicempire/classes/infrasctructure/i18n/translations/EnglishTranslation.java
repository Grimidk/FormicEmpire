...
public class EnglishTranslation implements Translation {
    ...
    public Map<String, String> getStrings() {
        ...
        en.put("TAB_RESEARCH_AVAILABLE", "Available");
        en.put("TAB_TRIGGERS", "Triggers");
        ...
        en.put("TRIGGER_PROGRESS_NONE", "No trigger progress yet. Keep expanding, researching, and exploring to reveal goals.");
        en.put("TRIGGER_PROGRESS_SHOW_COMPLETED", "Show completed");
        en.put("TRIGGER_PROGRESS_STATUS_UNLOCKED", "Unlocked");
        en.put("TRIGGER_PROGRESS_STATUS_PARTIAL", "In progress (%s/%s)");
        en.put("TRIGGER_PROGRESS_METRIC_FMT", "%s: %s / %s");
        en.put("TRIGGER_PROGRESS_METRIC_MONTHS", "Months elapsed");
        en.put("TRIGGER_PROGRESS_METRIC_CORPSES", "Dead ants");
        en.put("TRIGGER_PROGRESS_METRIC_RP", "Research points");
        en.put("TRIGGER_PROGRESS_METRIC_POPULATION", "Colony rank threshold");
        en.put("TRIGGER_PROGRESS_METRIC_COLONIES", "Colonies");
        en.put("TRIGGER_PROGRESS_METRIC_NUPTIALS", "Nuptial flights");
        en.put("TRIGGER_PROGRESS_METRIC_TRADES", "Active trades");
        ...
        en.put("TRIGGER_PROGRESS_HINT_POLICE", "Grow into a larger colony rank to unlock police.");
        en.put("TRIGGER_PROGRESS_HINT_COLONIES", "Found more colonies through nuptial flights and the world map.");
        en.put("TRIGGER_PROGRESS_HINT_NUPTIALS", "Launch nuptial flights from colonies with drones and breeders.");
        en.put("TRIGGER_PROGRESS_HINT_TRADES", "Establish active trade routes between colonies.");
        ...
        en.put("HATCH_SUBTYPE_HEAD_SECTION", "Head subtypes:");
        en.put("HATCH_SUBTYPE_ABDOMEN_SECTION", "Abdomen subtypes:");
        en.put("HATCH_SUBTYPE_ROW_TOTAL", "Row total");
        en.put("SUBTYPE_FOOD_COST_PER_TRAIT", "(+50% food consumption per active subtype part)");
        ...
        en.put("STATS_TAB_WORLD_HISTORY", "World History");
        en.put("STAT_BIRTH_RATE", "Birth Rate");
        en.put("HISTORY_FILTER_ALL", "All events");
        en.put("HISTORY_FILTER_OWN_ONLY", "Only my dynasty");
        en.put("HISTORY_FILTER_COLONY", "Colonies");
        en.put("HISTORY_FILTER_DYNASTY", "Dynasties");
        en.put("HISTORY_FILTER_WAR", "Wars");
        en.put("HISTORY_FILTER_BATTLE", "Battles");
        en.put("HISTORY_FILTER_REBELLION", "Rebellions");
        en.put("HISTORY_FILTER_NUPTIAL", "Nuptial flights");
        en.put("HISTORY_FILTER_ASSIMILATION", "Assimilations");
        en.put("HISTORY_COL_DATE", "Date");
        en.put("HISTORY_COL_CATEGORY", "Category");
        en.put("HISTORY_COL_EVENT", "Event");
        en.put("HISTORY_EMPTY", "No world history recorded yet.");
        en.put("HISTORY_UNKNOWN_DYNASTY_FMT", "Dynasty #%s");
        en.put("HISTORY_UNKNOWN_COLONY_FMT", "Colony #%s");
        en.put("HISTORY_UNKNOWN_ASSIMILATION_FMT", "Assimilation #%s");
        en.put("HISTORY_COLONY_FOUNDED_FMT", "%s founded by %s");
        en.put("HISTORY_COLONY_DIED_FMT", "%s of %s collapsed (%s)");
        en.put("HISTORY_DYNASTY_FORMED_FMT", "%s was founded");
        en.put("HISTORY_DYNASTY_DIED_FMT", "%s fell (%s)");
        en.put("HISTORY_DYNASTY_ABSORBED_FMT", "%s absorbed %s");
        en.put("HISTORY_DYNASTY_RANK_UP_FMT", "%s rose from %s to %s");
        en.put("HISTORY_CAPITAL_MOVED_FMT", "%s crowned a new capital: %s");
        en.put("HISTORY_WAR_STARTED_FMT", "%s declared war on %s (war #%s)");
        en.put("HISTORY_WAR_ENDED_FMT", "War #%s ended — winner: %s (%s)");
        en.put("HISTORY_BATTLE_FMT", "%s won a battle at %s (war #%s)");
        en.put("HISTORY_BATTLE_CAPTURE_FMT", "%s captured %s (war #%s)");
        en.put("HISTORY_REBELLION_FORMED_FMT", "%s rebelled from %s with %s colonies");
        en.put("HISTORY_REBELLION_FIGHT_FMT", "%s chose to fight the rebellion of %s");
        en.put("HISTORY_REBELLION_INDEPENDENCE_FMT", "%s granted independence to %s");
        en.put("HISTORY_NUPTIAL_FLIGHT_FMT", "Nuptial flight at %s (+%s queens, %s left to found)");
        en.put("HISTORY_ASSIMILATION_COMPLETED_FMT", "%s completed assimilation: %s");
        en.put("HISTORY_CAUSE_NO_QUEEN", "no queen");
        en.put("HISTORY_CAUSE_ZERO_ANTS", "no living ants");
        en.put("HISTORY_CAUSE_ALL_COLONIES_DEAD", "all colonies dead");
        en.put("HISTORY_CAUSE_EXTINCT", "extinct");
        en.put("HISTORY_CAUSE_EXTINCT_DEHYDRATION", "extinct (dehydration)");
        en.put("HISTORY_CAUSE_EXTINCT_EXHAUSTION", "extinct (resource exhaustion)");
        ...
        en.put("DYNASTY_DEFAULT_AUTO_TUNNELS_TOOLTIP", "Enable Auto-Tunnels on newly founded colonies.");
        ...
        en.put("STAT_SUBTYPE_FOOD_OVERHEAD", "Subtype food overhead");
        ...
        en.put("MAP_HOME_BUTTON", "Go Back Home");
        ...
        en.put("COLONY_NAME_DEFAULT_THEME", "Player");
        en.put("COLONY_NAME_ORDINAL_N_FMT", "%s %s");
        ...
        en.put("WAR_STAGE_WON_TITLE", "Battle Won");
        en.put("WAR_STAGE_LOST_TITLE", "Battle Lost");
        ...
        en.put("STAT_COMBAT_CAPACITY_DESC", "How many combatants your dynasty can field as active per battle line. Starts at 1,000; assigning a Queen as Commander (max 1 per colony; requires another queen off combat) raises it to 2,500 once for the dynasty. Extra assigned military wait as reserves and step into the line when active ants fall.");
        ...
        en.put("CITY_TITLE_CITY", "City");
        en.put("CITY_TITLE_BERG", "Berg");
        en.put("CITY_TITLE_GRAD", "Grad");
        en.put("CITY_TITLE_BURG", "Burg");
        en.put("CITY_TITLE_HAVEN", "Haven");
        en.put("CITY_TITLE_NEST", "Nest");
        en.put("CITY_TITLE_HOLD", "Hold");
        en.put("CITY_TITLE_FORD", "Ford");
        en.put("CITY_TITLE_FORT", "Fort");
        en.put("CITY_TITLE_CASTLE", "Castle");
        en.put("CITY_TITLE_PRIME", "Prime");
        en.put("CITY_TITLE_NEW", "New");
        ...
        en.put("DYNASTY_THEME_PLAYER", "Player");
        en.put("DYNASTY_THEME_OMNI", "Omni");
        en.put("DYNASTY_THEME_ANT", "Ant");
        en.put("DYNASTY_THEME_LEAF", "Leaf");
        en.put("DYNASTY_THEME_PLANT", "Plant");
        en.put("DYNASTY_THEME_SEED", "Seed");
        en.put("DYNASTY_THEME_PHARAOH", "Pharaoh");
        en.put("DYNASTY_THEME_RUBY", "Ruby");
        en.put("DYNASTY_THEME_TOPAZ", "Topaz");
        en.put("DYNASTY_THEME_MARAUDER", "Marauder");
        en.put("DYNASTY_THEME_SCORPION", "Scorpion");
        en.put("DYNASTY_THEME_COCKROACH", "Cockroach");
        en.put("DYNASTY_THEME_TRAPJAW", "Trapjaw");
        en.put("DYNASTY_THEME_TRAP", "Trap");
        en.put("DYNASTY_THEME_JAW", "Jaw");
        en.put("DYNASTY_THEME_HONEYPOT", "Honeypot");
        en.put("DYNASTY_THEME_HONEY", "Honey");
        en.put("DYNASTY_THEME_BEE", "Bee");
        en.put("DYNASTY_THEME_TURTLE", "Turtle");
        en.put("DYNASTY_THEME_SHELL", "Shell");
        en.put("DYNASTY_THEME_TORTOISE", "Tortoise");
        en.put("DYNASTY_THEME_CARPENTER", "Carpenter");
        en.put("DYNASTY_THEME_WOOD", "Wood");
        en.put("DYNASTY_THEME_TREE", "Tree");
        en.put("DYNASTY_THEME_WEAVER", "Weaver");
        en.put("DYNASTY_THEME_SILK", "Silk");
        en.put("DYNASTY_THEME_SPIDER", "Spider");
        en.put("DYNASTY_THEME_FLOODPLAIN", "Floodplain");
        en.put("DYNASTY_THEME_RIVER", "River");
        en.put("DYNASTY_THEME_WATER", "Water");
        en.put("DYNASTY_THEME_FIRE", "Fire");
        en.put("DYNASTY_THEME_FLAME", "Flame");
        en.put("DYNASTY_THEME_BURN", "Burn");
        en.put("DYNASTY_THEME_JET", "Jet");
        en.put("DYNASTY_THEME_TORNADO", "Tornado");
        en.put("DYNASTY_THEME_WIND", "Wind");
        en.put("DYNASTY_THEME_BULLET", "Bullet");
        en.put("DYNASTY_THEME_STING", "Sting");
        en.put("DYNASTY_THEME_PUNCH", "Punch");
        en.put("DYNASTY_THEME_ARMY", "Army");
        en.put("DYNASTY_THEME_SOLDIER", "Soldier");
        en.put("DYNASTY_THEME_WARRIOR", "Warrior");
        en.put("DYNASTY_THEME_GHOST", "Ghost");
        en.put("DYNASTY_THEME_SHADOW", "Shadow");
        en.put("DYNASTY_THEME_PHANTOM", "Phantom");
        en.put("DYNASTY_THEME_DRACULA", "Dracula");
        en.put("DYNASTY_THEME_VAMPIRE", "Vampire");
        en.put("DYNASTY_THEME_BLOOD", "Blood");
        en.put("DYNASTY_THEME_SILVER", "Silver");
        en.put("DYNASTY_THEME_METAL", "Metal");
        en.put("DYNASTY_THEME_GOLD", "Gold");
        en.put("DYNASTY_THEME_MARICOPA", "Maricopa");
        en.put("DYNASTY_THEME_VENOM", "Venom");
        en.put("DYNASTY_THEME_POISON", "Poison");
        en.put("DYNASTY_THEME_EXPLODING", "Exploding");
        en.put("DYNASTY_THEME_BOMB", "Bomb");
        en.put("DYNASTY_THEME_EXPLOSION", "Explosion");
        en.put("DYNASTY_THEME_BULLDOG", "Bulldog");
        en.put("DYNASTY_THEME_DOG", "Dog");
        en.put("DYNASTY_THEME_HOUND", "Hound");
        en.put("DYNASTY_THEME_SHINING", "Shining");
        en.put("DYNASTY_THEME_BLACK", "Black");
        en.put("DYNASTY_THEME_DARK", "Dark");
        en.put("DYNASTY_THEME_DESERT", "Desert");
        en.put("DYNASTY_THEME_SAND", "Sand");
        en.put("DYNASTY_THEME_DIRT", "Dirt");
        en.put("DYNASTY_THEME_LEAFCUTTER", "Leafcutter");
        en.put("DYNASTY_THEME_ROCK", "Rock");
        en.put("DYNASTY_THEME_IRON", "Iron");
        en.put("DYNASTY_THEME_MUSHROOM", "Mushroom");
        en.put("DYNASTY_THEME_MEAT", "Meat");
        en.put("DYNASTY_THEME_BUG", "Bug");
        en.put("DYNASTY_THEME_STONE", "Stone");
        en.put("DYNASTY_THEME_CLAY", "Clay");
        en.put("DYNASTY_THEME_STEEL", "Steel");
        en.put("DYNASTY_THEME_ICE", "Ice");
        en.put("DYNASTY_THEME_STORM", "Storm");
        en.put("DYNASTY_THEME_DUST", "Dust");
        en.put("DYNASTY_THEME_VINE", "Vine");
        en.put("DYNASTY_THEME_ROOT", "Root");
        en.put("DYNASTY_THEME_POLLEN", "Pollen");
        en.put("DYNASTY_THEME_WEB", "Web");
        en.put("DYNASTY_THEME_NIGHT", "Night");
        en.put("DYNASTY_THEME_DAY", "Day");
        ...
        en.put("DYNASTY_THEME_SWAMP", "Swamp");
        en.put("DYNASTY_THEME_MARSH", "Marsh");
        en.put("DYNASTY_THEME_OCEAN", "Ocean");
        en.put("DYNASTY_THEME_PEAK", "Peak");
        en.put("DYNASTY_THEME_VALLEY", "Valley");
        en.put("DYNASTY_THEME_CAVE", "Cave");
        en.put("DYNASTY_THEME_FOREST", "Forest");
        en.put("DYNASTY_THEME_JUNGLE", "Jungle");
        ...
        en.put("DIPLO_MODIFIER_WARMONGER", "Warmonger");
        ...
        en.put("DIPLO_PACT_INCOMING_POLICY_SECTION", "Incoming pact requests");
        en.put("DIPLO_PACT_INCOMING_POLICY_LABEL", "When another dynasty requests a non-aggression pact:");
        en.put("DIPLO_PACT_INCOMING_MANUAL", "Ask me (popup)");
        en.put("DIPLO_PACT_INCOMING_AUTO_ACCEPT", "Accept automatically");
        en.put("DIPLO_PACT_INCOMING_AUTO_DECLINE", "Decline automatically");
        ...
        en.put("DIPLO_DIPLOMATS_CURRENT_FMT", "Assigned: %s");
        en.put("DIPLO_DIPLOMATS_AVAILABLE_FMT", "Available: %s");
        en.put("DIPLO_DIPLOMATS_LIMIT_FMT", "Limit: %s");
        en.put("DIPLO_DIPLOMATS_TARGET_COUNT", "Assign");
        en.put("DIPLO_DIPLOMATS_EACH_FMT", "+%s each");
        en.put("DIPLO_DIPLOMATS_BONUS_PREVIEW_FMT", "Bonus: +%s (%s)");
        en.put("DIPLO_SEND_DIPLOMATS_FOR_FMT", "Send Diplomats — %s");
        ...
        en.put("DIPLO_ERROR_DIPLOMATS_AT_WAR", "Diplomats cannot be sent while at war with this dynasty.");
        ...
        en.put("SPECIES_TRAPJAW_SCIENTIFIC", "Odontomachus Hastatus");
        ...
        en.put("SPECIES_TURTLE_SCIENTIFIC", "Cephalotes Atratus");
        en.put("SPECIES_CARPENTER", "Carpenter Ant");
        en.put("SPECIES_CARPENTER_SCIENTIFIC", "Camponotus Pennsylvanicus");
        en.put("SPECIES_WEAVER", "Weaver Ant");
        en.put("SPECIES_WEAVER_SCIENTIFIC", "Oecophylla Smaragdina");
        ...
        en.put("SPECIES_DRACULA_SCIENTIFIC", "Mystrium Camillae");
        en.put("SPECIES_SILVER", "Saharan Silver Ant");
        en.put("SPECIES_SILVER_SCIENTIFIC", "Cataglyphis Bicolor");
        ...
        en.put("SPECIES_BULLDOG_SCIENTIFIC", "Myrmecia Pyriformis");
        ...
        en.put("ASSIMILATION_TRAPJAW", "Trapjaw");
        ...
        en.put("ASSIMILATION_HONEYPOT", "Honeypot");
        ...
        en.put("ASSIMILATION_DOORHEAD", "Doorhead");
        ...
        en.put("ASSIMILATION_WOODBURROW", "Wood Burrowing");
        ...
        en.put("ASSIMILATION_SILKWEAVE", "Silk Weaving");
        ...
        en.put("ASSIMILATION_RAFTING", "Rafting");
        ...
        en.put("ASSIMILATION_FIREVENOM", "Fire Venom");
        ...
        en.put("ASSIMILATION_JUMPING", "Jumping");
        ...
        en.put("ASSIMILATION_STINGING", "Stinging");
        ...
        en.put("ASSIMILATION_SWARMING", "Swarming");
        ...
        en.put("ASSIMILATION_STEALTH", "Stealth");
        ...
        en.put("ASSIMILATION_FASTBITE", "Fast Bite");
        ...
        en.put("ASSIMILATION_HEATRESIST", "Heat Resistance");
        ...
        en.put("ASSIMILATION_DEADLYVENOM", "Deadly Venom");
        ...
        en.put("ASSIMILATION_SELFDESTRUCT", "Selfdestruct");
        ...
        en.put("ASSIMILATION_FARSIGHT", "Farsight");
        ...
        en.put("ASSIMILATION_HIVEBUILD", "Hive Building");
        ...
        en.put("ASSIMILATION_LOCSENSE", "Location Sensing");
        ...
        en.put("ABILITY_AUTO_TUNNELS", "Auto-Tunnels");
        en.put("ABILITY_AUTO_TUNNELS_FLAVOR", "Auto-Tunnels");
        en.put("ABILITY_AUTO_TUNNELS_DESC", "Automated colonies assign borers and engineers to dig every possible tunnel link.");
        en.put("ABILITY_AUTO_DIPLOMACY", "Auto-Diplomacy");
        en.put("ABILITY_AUTO_DIPLOMACY_FLAVOR", "Auto-Diplomacy");
        ...
        en.put("ABILITY_SUBTYPE_HATCH_FLAVOR", "Morphology Hatch Rates");
        en.put("ABILITY_SUBTYPE_HATCH_DESC", "Adjust per-type head and abdomen subtype odds in the Hatch Rates dialog (P).");
        ...
        en.put("ABILITY_CLONING_DESC", "Enables genetic integrity gains from completed assimilations (+5% integrity floor each) and shows assimilated species drones in your colony. Satellite colonies still reduce genetic integrity.");
        ...
        en.put("ABILITY_DIPLOMAT_PRESSURE_3_DESC", "Each diplomat sent on a mission improves stability by 5 instead of 3.");
        ...
        en.put("HELP_UI_BAR_TITLE", "In-game control bar");
        en.put("HELP_UI_SPEEDS_TITLE", "Speed icons");
        en.put("HELP_UI_SPEED_PAUSED", "Paused");
        en.put("HELP_UI_SPEED_MS", "%s ms per tick");
        ...
        en.put("HOTKEY_X", "Statistics — tabs include World History, economy, population (toggles)");
        ...
        en.put("TRIGGER_SCOUT_ROLE_MSG", "Our foragers have harvested enough from a plant source! Workers feel the need to explore for new lands, unlocking the Scout role!");
        ...
        en.put("TRIGGER_AUTO_TUNNELS_TITLE", "Auto-Tunnels");
        en.put("TRIGGER_AUTO_TUNNELS_MSG", "Your dynasty has completed %s tunnels! Automated colonies can now dig every remaining link. Toggle Auto-Tunnels per colony in the Dynasty Overview (A).");
        en.put("TRIGGER_AUTO_DIPLOMACY_TITLE", "Auto-Diplomacy");
        en.put("TRIGGER_AUTO_DIPLOMACY_MSG", "Your dynasty has sent %s diplomatic missions! The capital and militant colonies can now stabilize loyalty automatically. Toggle Auto-Diplomacy in the Dynasty Overview (A).");
