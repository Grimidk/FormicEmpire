...
public class EnglishTranslation implements Translation {
    ...
    public Map<String, String> getStrings() {
        ...
        en.put("SPECIES_DOORHEAD", "Turtle Ant");
        en.put("SPECIES_DOORHEAD_SCIENTIFIC", "Cephalotes Sp.");
        en.put("SPECIES_WOODBURROW", "Carpenter Ant");
        en.put("SPECIES_WOODBURROW_SCIENTIFIC", "Camponotus Sp.");
        en.put("SPECIES_SILKWEAVE", "Weaver Ant");
        en.put("SPECIES_SILKWEAVE_SCIENTIFIC", "Oecophylla Sp.");
        en.put("SPECIES_RAFTING", "Floodplain Ant");
        en.put("SPECIES_RAFTING_SCIENTIFIC", "Formica Selysi");
        en.put("SPECIES_FIREVENOM", "Fire Ant");
        en.put("SPECIES_FIREVENOM_SCIENTIFIC", "Solenopsis Invicta");
        en.put("SPECIES_JUMPING", "Jet Ant");
        en.put("SPECIES_JUMPING_SCIENTIFIC", "Harpegnathos Saltator");
        en.put("SPECIES_GLIDING", "Gliding Ant");
        en.put("SPECIES_GLIDING_SCIENTIFIC", "Gliding Ant Sp.");
        en.put("SPECIES_STINGING", "Bullet Ant");
        en.put("SPECIES_STINGING_SCIENTIFIC", "Paraponera Clavata");
        en.put("SPECIES_SWARMING", "Army Ant");
        en.put("SPECIES_SWARMING_SCIENTIFIC", "Eciton Burchellii");
        en.put("SPECIES_STEALTH", "Ghost Ant");
        en.put("SPECIES_STEALTH_SCIENTIFIC", "Tapinoma Melanocephalum");
        en.put("SPECIES_FASTBITE", "Dracula Ant");
        ...
        en.put("SPECIES_FARSIGHT_SCIENTIFIC", "Myrmecia Sp.");
        en.put("SPECIES_HIVEBUILD", "Shining Black Ant");
        en.put("SPECIES_HIVEBUILD_SCIENTIFIC", "Lasius Fuliginosus");
        en.put("SPECIES_LOCSENSE", "Desert Ant");
        en.put("SPECIES_LOCSENSE_SCIENTIFIC", "Cataglyphis Fortis");
