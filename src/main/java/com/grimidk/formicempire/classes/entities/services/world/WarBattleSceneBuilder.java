...
public final class WarBattleSceneBuilder {
    ...
    public static WarBattleScene build(World world, War war, WarService warService) {
        ...
        return new WarBattleScene(
                ...
                attackerBiome,
                defenderBiome,
                new WarBattleScene.Side(stageAttacker.getName(), stageAttacker.getSpecies(), attackerCounts, attackerPower),
                new WarBattleScene.Side(stageDefender.getName(), stageDefender.getSpecies(), defenderCounts, defenderPower),
                war.getStagePhase(),
                frontline,
    ...
    private static WarBattleScene unavailable(War war, WarService warService, World world) {
        ...
        return new WarBattleScene(
                ...
                GameConstants.BIOME_PLAINS,
                new WarBattleScene.Side("?", GameConstants.SPECIES_OMNI, Map.of(), 0),
                new WarBattleScene.Side("?", GameConstants.SPECIES_OMNI, Map.of(), 0),
