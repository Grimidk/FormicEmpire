...
public class ColonyStarterServiceTest {
    ...
    public void testInitializeFirstColony() {
        ...
        assertEquals(9, colony.getWorkers().size(), "First colony should have 9 workers after maturation");
        assertEquals(1, colony.getAssignedRoleCount(GameConstants.ROLE_LAYER), "Should have 1 layer");
        assertEquals(3, colony.getAssignedRoleCount(GameConstants.ROLE_NURSE), "Should have 3 nurses");
        assertEquals(1, colony.getAssignedRoleCount(GameConstants.ROLE_FARMER), "Should have 1 farmer");
        assertEquals(5, colony.getAssignedRoleCount(GameConstants.ROLE_FORAGER), "Should have 5 foragers");
    }
